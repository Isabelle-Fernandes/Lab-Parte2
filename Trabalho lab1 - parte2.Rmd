...
cat(paste0("Valor-p do teste qui-quadrado: ", round(qui, 4),". ", paste0(if_else(qui>0.05, "Como o valor-p é superior a 0.05, não rejeitamos a hipótese nula e acredita-se que as variáveis são independentes.", "Como o valor-p é inferior a 0.05, rejeitamos a hipótese nula e acredita-se que as variáveis estão associadas." ))))
```

```
paste("Valor-p do teste qui-quadrado:", round(qui, 4),".")
...
variáveis grupo com cada uma das outras variáveis categóricas.
...
$H_1$: As variáveis **grupo** com cada uma das outras variáveis estão associadas.
...
>>>>>>> 74bc56928502fd73bad3925f4721a4980ebb6bf5
...
Foram estimados dois modelos em que todos os coeficientes são
...
Assin   toticamente, pode-se escrever:
...
<<<<<<< HEAD
$\mathbf{X}^{2}_{112}$ com \alpha = 0.05 é 137.7015. Como 0 \< 100 \<
=======
