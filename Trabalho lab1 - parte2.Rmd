...
banco_principais <- banco_principais %>%
  mutate(Filmes = sapply(X, check_option, option = "Filmes"),
         ...
         Outros = sapply(X, check_option, option = "Outros"))

# Optionally, you can convert the new columns to factors
banco_principais[, c("Filmes", "Novelas", "Seriados", "Clipes_de_musica", "Outros")] <- lapply(banco_principais[, c("Filmes", "Novelas", "Seriados", "Clipes_de_musica", "Outros")], as.factor)
