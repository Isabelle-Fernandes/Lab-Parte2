...
banco_principais <- as.data.frame(banco[,c(3,4,5,6,7,8,9,10,11,13,14,15,16,17,18,20,21,23,24,26,28)])
...
banco_principais[, c("Filmes", "Novelas", "Seriados", "Clipes_de_musica")] <- lapply(banco_principais[, c("Filmes", "Novelas", "Seriados", "Clipes_de_musica")], as.factor)
