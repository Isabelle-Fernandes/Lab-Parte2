...
pelas variáveis: - Visita a parques, praças e espaços na natureza
exibidos na tela; - Filmes; - Satisfação; - Desfrute da gastronomia
retratada na tela, incluindo alimentos e bebidas.

O modelo 2, como mostrado abaixo, a variável binária grupo é explicada
pelas variáveis: - Visita a parques, praças e espaços na natureza
exibidos na tela; - Filmes; - Desfrute da gastronomia retratada na tela,
...
Para o modelo, D = 100.0668. A média da distribuição
$\mathbf{X}^{2}_{12}$ é 112. D está próximo da média, logo podemos
...
# Tabela - Regressores, coeficientes, Valor-p e $\mathbf{e}^{\eta}$
...
colnames(coeficiente) <- c("Coeficiente", "Valor-p", "exp{beta}")
...
# Gráficos de resíduos contra os valores ajustados do modelo
...
Por, abaixo o gráfico evidencia a probalidade de um indvpiduo ser classificado como pertencente ao grupo "específico", conforme o modelo prevê. Os valores reais do grupo são 27
